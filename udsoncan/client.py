...
# ====  ReadDTCInformation
    ...
    def deauthenticate(self) -> Optional[services.Authentication.InterpretedResponse]:
        """
        Sends a deAuthenticate request (sub function of Authentication Service)
        introduced in 2020 version of ISO-14229-1.

        :Effective configuration: ``exception_on_<type>_response``

        :return: The server response parsed by
         :meth:`Authentication.interpret_response<udsoncan.services.Authentication.interpret_response>`
        :rtype: :ref:`Response<Response>`
        """
    ...
    def verify_certificate_unidirectional(self,
        ...
        :param communication_configuration: Configuration information about how to proceed with security
    ...
    def verify_certificate_bidirectional(self,
        ...
        :param challenge_client: The challenge contains vehicle manufacturer specific formatted client data
         (likely containing randomized information) or is a random number.
        :type challenge_client: bytes
    ...
    def proof_of_ownership(self,
        ...
        :param proof_of_ownership_client: Proof of Ownership of the previous given challenge to be verified by
         the server.
    ...
    def transmit_certificate(self,
        ...
        :param certificate_evaluation_id: Unique ID to identify the evaluation type of the transmitted
    ...
    def request_challenge_for_authentication(self,
        ...
        :param algorithm_indicator: Indicates the algorithm used in the generating and verifying Proof of
    ...
    def authentication_configuration(self) -> Optional[services.Authentication.InterpretedResponse]:
        """
        Sends a authenticationConfiguration request (sub function of Authentication Service)
        introduced in 2020 version of ISO-14229-1.
    ...
    def authentication(self,
         ...
         services.Authentication.InterpretedResponse]:
        """
        Sends an Authentication request introduced in 2020 version of ISO-14229-1. You can also use the helper functions
        to send each authentication task (sub function).
